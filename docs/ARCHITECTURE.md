...
**Current app release:** [`app-v0.1.20`](https://github.com/MoonMaxTea/Accounting-Copilot/releases/tag/app-v0.1.20) — see [RELEASE-NOTES.md](./RELEASE-NOTES.md).
...
```bash
cd app/src-tauri && cargo run --example continue_path_check
cd app/src-tauri && DEEPSEEK_API_KEY=... cargo run --example agent_live_check -- deepseek-v4-flash
```
