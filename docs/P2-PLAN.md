...
> 状态：**计划中，暂未实施**（当前基线：**App v0.1.14**，Agent-only AI）。  
> 本文件由技术审计（2026-06-21）产出，记录在 P0/P1 修复及 v0.1.13/v0.1.14 发版完成后、需要单独立项推进的架构级优化。
>
> 关联：P0/P1 已在 PR #14 落地；Agent-only 与 Windows Continue 修复见 [RELEASE-NOTES.md](./RELEASE-NOTES.md)。本计划只覆盖 **P2**。
