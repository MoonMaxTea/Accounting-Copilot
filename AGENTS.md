...
| **Current app version** | **0.1.17** (`app-v0.1.17`) — see [docs/RELEASE-NOTES.md](docs/RELEASE-NOTES.md) |
...
Both URLs are raced simultaneously (`futures_util::future::select`); the fastest successful response wins.
